    ...
    <div className="py-5 px-4">
      ...
      <div className="flex flex-col mt-9 gap-3">
        <div className="">
          ...
          <div className="bg-white px-6 py-14 flex justify-center lg:justify-normal items-center gap-10 lg:gap-5 rounded-lg">
            <DonutChart
              strokeWidth={0}
              data={[
        ...
        <div className="w-full">
          ...
          <div className="bg-white px-1 py-5 flex items-center gap-5 rounded-lg">
            <AreaChart
              h={300}
              data={[
                { date: "Jan", Apples: 50 },
